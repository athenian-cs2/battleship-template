...
public class MyTests {
  ...
  public void testHit() {
    ...
    assertEquals(
        false,
        MyMain.hit(board, 1, 3),
        "The expected output for whether there is a hit at (1, 3) of boolean[][] \n"
    ...
    assertEquals(
        true,
        MyMain.hit(board, 2, 2),
        "The expected output for whether there is a hit at (2, 2) of boolean[][] \n"
            + "board = { {false, false, false, false, false}, \n"
            + "       {false, false, false, false, false},\n"
            + "       {false, true, true, true, false},\n"
            + "       {false, false, false, false, false},\n"
  ...
  public void testPlaceBoard() {
    ...
    assertEquals(
        ...
        "Direction = \"right\", boatLength = 3, row = 0, col = 0, and \n"
            + "board = { {false, false, false, false, false}, \n"
            + "       {false, false, false, false, false},\n"
            + "       {false, true, true, true, false},\n"
            + "       {false, false, false, false, false},\n"
    ...
    assertEquals(
        answer2,
        Arrays.deepToString(board),
        "Direction = \"down\", boatLength = 4, row = 1, col = 2, and \n"
